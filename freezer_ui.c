...
const char str_freeze_ctrl19[] = "OPERATING SYSTEM";
const char str_freeze_ctrl1A[] = "ID      :";
const char str_freeze_ctrl1B[] = "255";
...
char	str_freeze_page[] = "TEST PAGE";
